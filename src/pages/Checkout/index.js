      ...
      <Column className="bg-white_A700 font-mada items-center mx-[auto] w-[100%]">
        <Column className="bg-gradient  3xl:pb-[100px] lg:pb-[65px] xl:pb-[74px] 2xl:pb-[84px] rounded-radius5 w-[100%]">
          ...
          <Column className="xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[93px] lg:mt-[31px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[35%]">
            <Row className="font-poppins ml-[1px] w-[26%]">
        ...
        <Column className="lg:mt-[64px] xl:mt-[73px] 2xl:mt-[83px] 3xl:mt-[99px] lg:px-[101px] xl:px-[116px] 2xl:px-[131px] 3xl:px-[157px] w-[100%]">
          <Text className="font-bold lg:text-[28px] xl:text-[32px] 2xl:text-[36px] 3xl:text-[43px] text-gray_900 w-[auto]">
            Cart Product
          </Text>
        </Column>
        <Row className="lg:mt-[36px] xl:mt-[41px] 2xl:mt-[47px] 3xl:mt-[56px] w-[83%]">
          <Column className="w-[69%]">
            <Stack className="bg-gray_100 lg:h-[191px] xl:h-[218px] 2xl:h-[246px] 3xl:h-[295px] lg:px-[31px] xl:px-[35px] 2xl:px-[40px] 3xl:px-[48px] w-[95%]">
              <Row className="absolute bottom-[0] justify-center left-[0] w-[19%]">
                <Text className="font-bold lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-indigo_A200 w-[auto]">
                  product notes
                </Text>
                <Img
                  src="images/img_arrowleft.svg"
                  className="lg:h-[6px] xl:h-[7px] 2xl:h-[8px] 3xl:h-[9px] lg:ml-[15px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] mt-[3px] w-[10%]"
                  alt="arrowleft"
                />
              </Row>
              <Column className="absolute h-[max-content] inset-[0] items-end justify-center m-[auto] w-[90%]">
                <Row className="items-center justify-between mr-[3px] w-[99%]">
                  <Img
                ...
                <Row className="bg-white_A700 items-center justify-end ml-[auto] lg:mt-[28px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] w-[20%]">
                  <Img
                    src="images/img_vector36_gray_900.svg"
                    className="xl:h-[2px] lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] w-[13%]"
                    alt="VectorThirtySix"
                  />
                  ...
                  <Img
                    ...
                    className="lg:h-[12px] xl:h-[14px] 2xl:h-[16px] 3xl:h-[19px] lg:ml-[27px] xl:ml-[31px] 2xl:ml-[35px] 3xl:ml-[42px] mr-[1px] lg:w-[11px] xl:w-[13px] 2xl:w-[15px] 3xl:w-[18px]"
                    alt="plus"
                  />
                </Row>
              </Column>
            </Stack>
            <Column className="bg-gray_100 items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[31px] xl:p-[35px] 2xl:p-[40px] 3xl:p-[48px] w-[95%]">
              ...
              <Row className="lg:mt-[28px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] w-[100%]">
                <Text className="font-bold lg:mt-[22px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-indigo_A200 w-[auto]">
                  product notes
                </Text>
                <Img
                  src="images/img_arrowleft.svg"
                  className="lg:h-[6px] xl:h-[7px] 2xl:h-[8px] 3xl:h-[9px] lg:ml-[15px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] lg:mt-[24px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[2%]"
                  alt="arrowleft One"
                />
                <Row className="bg-white_A700 items-center justify-between lg:ml-[321px] xl:ml-[367px] 2xl:ml-[413px] 3xl:ml-[495px] lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] w-[20%]">
                  <Img
                    src="images/img_vector36.svg"
                    className="xl:h-[2px] lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] ml-[1px] w-[13%]"
                    alt="VectorThirtySix One"
                  />
                  <Text className="font-bold mt-[1px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_900 w-[auto]">
                    1
                  </Text>
                  <Img
                    src="images/img_plus.svg"
          ...
          <Column className="bg-gray_100 mt-[1px] lg:p-[17px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] w-[32%]">
            <Text className="font-bold font-mada ml-[1px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_900 w-[auto]">
              Coupon Code
            </Text>
            <Input
              className="w-[100%]"
              wrapClassName="2xl:h-[49px] 2xl:mt-[8px] 3xl:h-[58px] 3xl:mt-[9px] flex lg:h-[38px] lg:mt-[6px] ml-[1px] w-[99%] xl:h-[43px] xl:mt-[7px]"
              name="Rectangle115"
              placeholder=""
              variant="FillWhiteA700"
            ></Input>
            <Button
              className="font-bold font-poppins lg:ml-[117px] xl:ml-[134px] 2xl:ml-[151px] 3xl:ml-[181px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[54%]"
              size="md"
              variant="OutlineBlack90019"
            >
              Check
            </Button>
            <Row className="font-mada items-center justify-between ml-[1px] lg:mt-[28px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] w-[99%]">
            ...
            <Text className="font-mada font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] not-italic lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_500 w-[auto]">
              4 Product
            </Text>
            <Line className="bg-gray_300 h-[2px] ml-[1px] lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] w-[99%]" />
            <Row className="font-mada items-center justify-between ml-[1px] lg:mt-[17px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] w-[99%]">
              <Text className="font-bold mb-[1px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_900 w-[auto]">
                Total
              </Text>
              <Text className="font-normal mt-[1px] not-italic lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_900 w-[auto]">
            ...
            <Button
              className="font-bold font-poppins lg:mb-[13px] xl:mb-[15px] 2xl:mb-[17px] 3xl:mb-[20px] lg:ml-[117px] xl:ml-[134px] 2xl:ml-[151px] 3xl:ml-[181px] lg:mt-[20px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[54%]"
              size="md"
              variant="OutlineBlack90019"
            >
              Checkout
        ...
        <Column className="lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] xl:px-[107px] 2xl:px-[121px] 3xl:px-[145px] lg:px-[94px] w-[100%]">
          <Stack className="bg-gray_100 lg:h-[191px] xl:h-[218px] 2xl:h-[246px] 3xl:h-[295px] lg:px-[31px] xl:px-[35px] 2xl:px-[40px] 3xl:px-[48px] w-[65%]">
            <Row className="absolute bottom-[0] justify-center left-[0] w-[19%]">
              <Text className="font-bold lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-indigo_A200 w-[auto]">
                product notes
              </Text>
