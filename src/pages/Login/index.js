    ...
    <>
      <Column className="bg-white_A700 font-poppins items-center mx-[auto] w-[100%]">
        <Column
          ...
          style={{ backgroundImage: "url('images/img_group440.png')" }}
        >
          <Column className="bg-gradient1  lg:pb-[62px] xl:pb-[71px] 2xl:pb-[80px] 3xl:pb-[96px] w-[100%]">
            ...
            <Column className="xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[93px] lg:mt-[31px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[76%]">
              <Row className="font-poppins w-[17%]">
              ...
              <Stack className="lg:h-[329px] xl:h-[377px] 2xl:h-[424px] 3xl:h-[508px] lg:mt-[15px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[100%]">
                <Text className="absolute font-bold font-mada left-[0] lg:text-[28px] xl:text-[32px] 2xl:text-[36px] 3xl:text-[43px] text-white_A700 top-[8%] w-[auto]">
                  Login
                </Text>
                <Text className="absolute font-normal font-poppins left-[0] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 top-[24%] w-[auto]">
                  <span className="text-white_A700">Don’t have accout ?</span>
                  <span className="text-black_900"> </span>
                  <span className="text-white_A700 font-bold">Sign Up </span>
                </Text>
                <Input
                  className="font-normal font-poppins left-[0] not-italic p-[0] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] placeholder:text-gray_900 text-gray_900 top-[0] w-[100%]"
                  wrapClassName="2xl:mt-[143px] 3xl:mt-[171px] absolute flex lg:mt-[111px] top-[34%] w-[16%] xl:mt-[127px]"
                  name="Group1915"
                  placeholder="Google"
                  prefix={
                    <Img
                      src="images/img_google.svg"
                      className="absolute lg:w-[11px] lg:ml-[17px] lg:mr-[18px] xl:w-[13px] xl:ml-[19px] xl:mr-[21px] 2xl:w-[15px] 2xl:ml-[22px] 2xl:mr-[24px] 3xl:w-[18px] 3xl:ml-[26px] 3xl:mr-[28px] my-[auto] inset-x-[2%]"
                      alt="google"
                    />
                  }
                  size="sm"
                ...
                <Input
                  className="font-normal font-poppins left-[0] not-italic p-[0] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] placeholder:text-gray_900 text-gray_900 top-[0] w-[100%]"
                  wrapClassName="2xl:ml-[204px] 2xl:mt-[143px] 3xl:ml-[244px] 3xl:mt-[171px] absolute flex left-[19%] lg:ml-[158px] lg:mt-[111px] top-[34%] w-[16%] xl:ml-[181px] xl:mt-[127px]"
                  name="Group1916"
                  placeholder="Facebook"
                  prefix={
                    <Img
                      src="images/img_facebook.svg"
                      className="absolute lg:w-[6px] lg:ml-[15px] lg:mr-[21px] xl:w-[7px] xl:ml-[17px] xl:mr-[24px] 2xl:w-[8px] 2xl:ml-[20px] 2xl:mr-[27px] 3xl:w-[9px] 3xl:ml-[24px] 3xl:mr-[32px] my-[auto] inset-x-[2%]"
                      alt="facebook"
                    />
                  }
                  size="sm"
                  variant="FillWhiteA700"
                ></Input>
                <Stack className="absolute font-poppins lg:h-[329px] xl:h-[377px] 2xl:h-[424px] 3xl:h-[508px] w-[100%]">
                  <Column className="absolute bottom-[0] left-[0] w-[54%]">
                    <Text className="font-bold lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-white_A700 w-[auto]">
                      Email
                    </Text>
                    <Column className="bg-white_A700 lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] w-[100%]">
                      <Text className="font-normal mb-[1px] 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] not-italic lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-red_800 w-[auto]">
                        Email
                      </Text>
                    </Column>
                    <Text className="font-bold lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-white_A700 w-[auto]">
                      Password
                    </Text>
                    <Row className="bg-white_A700 items-center justify-between lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] w-[100%]">
                      <Text className="font-normal mb-[1px] 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] not-italic lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-red_701 w-[auto]">
                        Password
                      </Text>
                      <Img
                        src="images/img_eye.svg"
                        className="lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] lg:mr-[6px] xl:mr-[7px] 2xl:mr-[8px] 3xl:mr-[9px] my-[1px] w-[3%]"
                        alt="eye"
                      />
                    </Row>
                  </Column>
                  <Img
                    ...
                    className="absolute lg:h-[307px] xl:h-[351px] 2xl:h-[395px] 3xl:h-[474px] right-[0] top-[0] w-[49%]"
                    alt="ArrowOne"
                  />
                </Stack>
              </Stack>
              <Row className="font-poppins lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[54%]">
                <CheckBox
                  className="font-bold lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-gray_100"
                  inputClassName="h-[24px] mr-[5px] w-[24px]"
                  name="RememberMe"
                  label="Remember Me"
                ></CheckBox>
                <Text className="font-bold lg:ml-[242px] xl:ml-[277px] 2xl:ml-[312px] 3xl:ml-[374px] mt-[4px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-gray_100 w-[auto]">
                  Forget Password ?
                </Text>
              </Row>
              <Button
                className="font-bold font-poppins lg:ml-[317px] xl:ml-[362px] 2xl:ml-[408px] 3xl:ml-[489px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[16%]"
                size="md"
